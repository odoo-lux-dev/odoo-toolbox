...
Project Favorites are the flagship feature of the Odoo.SH part of Odoo Toolbox. They let you pin your most-used Odoo.SH projects, give them custom names, and reorder them however you like - so you can access what you need at a glance, without having to search through the full project list.

Favorites are accessible from three places:

- The **Extension Popup** - from any page, even outside of Odoo.SH.
...
![Project Favorites - add a favorite](/img/odoosh/favorites/projects-list.png)
...
To rename a favorite, go to the Odoo Toolbox extension options, then to the "SH Favorites" section. Click the edit button of the favorite you want to rename, type the new name, and press Enter to save.
...
![Project Favorites - access from popup](/img/odoosh/favorites/popup-list.png)

:::info
To open a project in a new tab, hold <kbd>Ctrl</kbd> (<kbd>Cmd</kbd> on Mac) while clicking the favorite in the popup. You can also middle-click to open the project in a new tab.
:::
