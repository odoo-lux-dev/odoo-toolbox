...
Odoo Toolbox enhances your experience on any Odoo instance with a set of tools designed for developers and power users. These features are available on all supported Odoo databases (v14+).
...
Smaller features that enhance your Odoo experience: technical model name display on records, PDF/HTML report generation, and more.
