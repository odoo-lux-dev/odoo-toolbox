...
describe("getValueTemplate", () => {
  test("should return empty template for many2one", () => {
...
describe("buildSuggestions", () => {
  ...
  test("should build suggestions without filter", () => {
    ...
    const suggestions = buildSuggestions(mockFieldsMetadata, usedFields, "");
  ...
  test("should filter suggestions by partial text", () => {
    ...
    const suggestions = buildSuggestions(mockFieldsMetadata, usedFields, "user");
  ...
  test("should prioritize fields starting with filter", () => {
    ...
    const suggestions = buildSuggestions(mockFieldsMetadata, usedFields, "par");
  ...
  test("should include field descriptions and examples", () => {
    ...
    const suggestions = buildSuggestions(mockFieldsMetadata, usedFields, "name");
