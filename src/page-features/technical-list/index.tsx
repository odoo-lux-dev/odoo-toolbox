...
import { TechnicalSidebar } from "@/screens/technical-list/components/technical-sidebar";
...
const shouldExcludeTechnicalList = () => technicalListExclusionRules.some((rule) => rule());
...
export const initTechnicalList = (): void => {
  try {
    ...
    if (showTechnicalList && !shouldExclude && !containerElement && window.odoo) {
