...
export const MAJOR_UPDATES: UpdateConfig[] = [
  {
    ...
    description:
      "Bonjour! ¡Hola! Hello! Odoo Toolbox is now available in 10 languages: English, French, Spanish, Arabic, German, Portuguese (BR/PT), Italian, Hindi and Dutch.",
    mainFeature: {
      icon: "globe-02",
      title: "Multi-Language Support",
      description:
        "The entire extension is now translated! Switch between 10 languages from the extension options.",
    },
    activationMethods: [
      {
        icon: "settings-02",
        text: "Open the extension options",
        action: "openSettings",
      },
      {
        icon: "globe-02",
        text: "Use the language switcher in the top-left of the sidebar",
      },
      {
        icon: "rocket-01",
        text: "Select your preferred language. Changes apply instantly!",
      },
    ],
    customSections: [
      {
        ...
        content:
          "These translations were generated with AI assistance. Therefore, there may be occasional errors or unnatural phrasing. If you spot any issue, please don't hesitate to report it on GitHub.",
        type: "warning",
      },
      {
        title: "Want to help?",
        content:
          "If you'd like to add a new language, improve an existing translation, or report a mistake, check the 'Improve a translation' link in the options sidebar or visit our GitHub repository. Every contribution is welcome!",
        type: "info",
      },
    ],
    releaseNotes: [
      "Full internationalization with 10 supported languages",
      "Languages: English, French, Spanish, Arabic, German, Portuguese (BR & PT), Italian, Hindi, Dutch",
      "Automatic language detection from browser preferences (Auto mode)",
      "Right-to-left (RTL) layout support",
      "Language switcher in the options sidebar",
      "All extension pages translated: popup, options, devtools, technical sidebar, update page",
    ],
  },
  {
    version: "1.6.0",
