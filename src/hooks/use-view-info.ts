...
import { getOdooWindowObject, isOnSpecificRecordPage } from "@/utils/utils"
...
export const useViewInfo = () => {
        ...
        canOptimizeSeo:
          canOptimizeSeo === "True"
            ...
            : canOptimizeSeo === "False"
              ...
              : null,
        canPublish:
          canPublish === "True" ? true : canPublish === "False" ? false : null,
        isEditable:
          isEditable === "1" ? true : isEditable === "0" ? false : null,
    ...
    (fieldElement: Element): EnhancedTechnicalFieldInfo => {
          ...
          if (
            ...
            if (row) {
              ...
              if (headerRow && cellIndex >= 0) {
                ...
                labelElement =
                  headerCell?.querySelector(".o_column_title, span") ||
                  headerCell
              }
            }
          }
      ...
      if (debugInfo) {
        ...
        if (typeof debugInfo.required === "boolean") {
          ...
          isRequired =
            debugInfo.required === "True" || debugInfo.required === "1"
          canBeRequired =
            debugInfo.required === "True" || debugInfo.required === "1"
        } else if (
          debugInfo.required &&
        ...
        if (typeof debugInfo.readonly === "boolean") {
          ...
          isReadonly =
            debugInfo.readonly === "True" || debugInfo.readonly === "1"
          canBeReadonly =
            debugInfo.readonly === "True" || debugInfo.readonly === "1"
        } else if (
          debugInfo.readonly &&
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      const errorMessage =
        err instanceof Error ? err.message : "Failed to load view information"
