...
declare module "@/utils/odoo-py_js/py.js" {
   ...
   */
  export function evaluateExpr(expr: string, context?: Record<string, unknown>): unknown;

  /**
   * Evaluates a python expression to return a boolean
   */
  export function evaluateBooleanExpr(expr: string, context?: Record<string, unknown>): boolean;
   ...
   * Evaluate an AST
   */
  export function evaluate(ast: AST, context?: Record<string, unknown>): unknown;
