...
Les projets favoris sont la fonctionnalité phare de la partie Odoo.SH d'Odoo Toolbox. Ils vous permettent d'épingler vos projets Odoo.SH les plus utilisés, de leur donner des noms personnalisés et de les réorganiser à votre guise. Ainsi, vous pouvez accéder à ce dont vous avez besoin en un coup d'œil, sans avoir à chercher dans la liste complète des projets.

Les favoris sont accessibles depuis deux endroits :

- Le **popup de l'extension** - depuis n'importe quelle page, même en dehors d'Odoo.SH.
...
![Projets favoris - ajouter un favori](/img/odoosh/favorites/projects-list.png)
...
Pour renommer un favori, accédez aux options de l'extension Odoo Toolbox, puis à la section "SH Favorites". Cliquez sur le bouton d'édition du favori que vous souhaitez renommer, saisissez le nouveau nom et appuyez sur "Entrée" pour enregistrer.
...
![Projets favoris - accès depuis le popup](/img/odoosh/favorites/popup-list.png)

:::info
Pour ouvrir un projet dans un nouvel onglet, maintenez la touche <kbd>Ctrl</kbd> (<kbd>Cmd</kbd> sur Mac) en cliquant sur le favori dans le popup. Vous pouvez également faire un clic molette pour ouvrir le projet dans un nouvel onglet.
:::
