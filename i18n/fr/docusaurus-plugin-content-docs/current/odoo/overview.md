...
Odoo Toolbox enrichit votre expérience sur n'importe quelle instance Odoo grâce à un ensemble de fonctionnalités conçues pour les utilisateurs ainsi que les développeurs. Ces fonctionnalités sont disponibles sur toutes les bases de données Odoo supportées (v14+).
...
Des fonctionnalités plus légères qui améliorent votre expérience Odoo : affichage du nom technique du modèle sur les enregistrements, génération de rapports PDF/HTML, et plus encore.
