...
Ce modèle s'affiche donc uniquement sur les versions 17.2 et ultérieures d'Odoo.

![Nom technique du modèle](/img/additional-features/technical-name.png)
...
![Aperçu de rapports](/img/additional-features/report-preview.png)

## Boutons de connexion rapide

Odoo Toolbox ajoute des boutons de connexion rapide sur les pages de connexion d'Odoo. Trois boutons sont disponibles :
...
:::tip
Ceci est particulièrement utile sur les instances de développement ou de test. Sur les runbots d'Odoo également.
:::

![Boutons de connexion rapide](/img/additional-features/quick-connect-buttons.png)
